...
[Contact Ted](/contact.html) about doing one of the workshops listed below, or have a glance at [the list of topics he can cover](/presentations/) and ask him to put together a workshop geared specifically for your team.
...
Get an early glimpse at the katas by visiting the [official website](https://www.architecturalkatas.com) or the [GitHub repo](https://github.com/tedneward/ArchitecturalKatas).

### Busy Developer's Workshop: Technical Speaking
Want to get developers to learn how to give great technical presentations? Want to give your developer advocates a leg up on winning over conference crowds? In this workshop, we'll spend time crafting abstracts, building out talks, and practicing delivery. Along the way, we'll begin the process of transforming a developer into a technical presenter that can command the attention of a room with a presentation that is equally informative as it is engaging.
...
## University
Ted is an adjunct professor for the University of Washington Informatics School ("iSchool"). In particular, he's taught the following courses:
