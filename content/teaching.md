...
Building an enterprise system (whether on-prem or in the cloud) is a tricky thing. A number of pitfalls await the unwary, but fortunately, help is available; all we have to do is keep in mind a number of key aspects, many of which we've known for years but have simply lost sight of in the rush to embrace new tools and technology. In this workshop, based on Ted's book "Effective Enterprise Java" (but which is startlingly technology-agnostic), we'll go over a number of the things architects and developers need to keep in mind when working with enterprise systems, whether building them in 2005, 2015 or 2025.
...
### Busy Developer's Workshop on Building Languages
...
### Busy Developer's Workshop: "Startup In A Box"
