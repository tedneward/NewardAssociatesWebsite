title=Busy Developer's Guide to Auth-n-Auth
type=talk
audience=For any intermediate developer (2 or more years) audience
tags=presentation, distributed systems,security,developer
date=2023-06-01
status=published
~~~~~~
...
Slides: [HTML](http://slides.newardassociates.com/BusyDevsGuide/AuthnAuth.html) | [PPTX](http://slides.newardassociates.com/BusyDevsGuide/AuthnAuth.pptx)
