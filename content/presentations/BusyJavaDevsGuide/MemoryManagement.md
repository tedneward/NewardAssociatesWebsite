title=Busy Java Developer's Guide to Memory Management
type=talk
...
Actually, it's not all that hard to understand at all, and in this presentation, we're going to take a JVM-specific view of how GC works. We'll talk about what the implications of automatic memory management are, how its approach can trip up developers, and some of the various mechanisms different platforms have provided over the years to try and address the shortcomings.
    
<hr />

Slides: [HTML](http://slides.newardassociates.com/BusyJavaDevsGuide/MemoryManagement.html) | [PPTX](http://slides.newardassociates.com/BusyJavaDevsGuide/MemoryManagement.pptx)
